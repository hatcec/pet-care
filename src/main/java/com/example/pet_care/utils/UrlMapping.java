...
public class UrlMapping {
    ...
    public static final String UPDATE_PHOTO = "/update/{photoId}";
    public static final String DELETE_PHOTO = "/delete/{photoId}/{userId}";
    public static final String GET_PHOTO_BY_ID = "/get/{photoId}";
}
